-- CONFIG
APP_NAME = "gabalexot"  -- config dir/files in appdata
APP_VERSION = 1341
DEFAULT_LAYOUT = "retro"

-- Disable default OTCv8 online services unless you use your own updater/crash/status backend
Services = {
  website = "",
  updater = "",
  stats = "",
...
-- First entry: NAS/LAN
Servers = {
  -- GabalexOT på NAS / lokalt nätverk
  GabalexOT = "192.168.50.80:7171:860",

  -- GabalexOT via publik IP
  GabalexOnline = "83.227.227.98:7171:860",

  -- Bara om servern körs på samma dator som klienten
  GabalexLocal = "127.0.0.1:7171:860",
}

--Server = "ws://127.0.0.1:88/"
--USE_NEW_ENERGAME = true

ALLOW_CUSTOM_SERVERS = true

g_app.setName("GabalexOT")
-- CONFIG END
